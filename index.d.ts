export declare class ContentBasedRecommender {
  /**
   ...
   */
  getSimilarDocuments(id: string, start?: number, size?: number): DocumentVector[];
  /**
   * @return {Export}
   */
  export(): Export;
   ...
   */
  _processDocuments(documents: Document[], options?: Options[]): ProcessedDocument[];
  /**
   ...
   */
  _produceWordVectors(processedDocuments: ProcessedDocument[], options: Options): DocumentVector[];
  /**
   ...
   * @returns {Data}
   */
  _calculateSimilaritiesBetweenTwoVectors(documentVectors: DocumentVector[], targetDocumentVectors: DocumentVector[], options: Options): Data;
  /**
   * @param {DocumentVector[]} documentVectors
   ...
   * @returns {Data}
   */
  _calculateSimilarities(documentVectors: DocumentVector[], options: Options): Data;
  /**
